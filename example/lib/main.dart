...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Text Selection Controls',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(primaryColor: Color(0xffffc41d)),
      home: ReadingApp(),
    );
  }
}
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(icon: Icon(Icons.brightness_3_outlined), label: 'theme'),
